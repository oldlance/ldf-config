...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="ganymede"
	...
	export TMUX_POWERLINE_STATUS_RIGHT_LENGTH="104"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/lance/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/mail/lance"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/lance/.mailcheckrc"
# }
...
# pwd.sh {
	...
	export TMUX_POWERLINE_SEG_PWD_MAX_LEN="25"
# }
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-v -q -c -l 89 -r 235"
# }
